class DeleteBodyInfoRequestModel {
  final int id;
  ...
  DeleteBodyInfoRequestModel copyWith({
    int? id,
    String? nickname,
    String? address,
    String? phone,
  ...
  factory DeleteBodyInfoRequestModel.fromJson(Map<String, dynamic> json) {
    return DeleteBodyInfoRequestModel(
      id: json['id'],
