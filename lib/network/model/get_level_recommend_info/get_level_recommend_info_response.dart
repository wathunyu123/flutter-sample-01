class GetLevelRecommendInfoResponseModel {
  final Section recommend;

  GetLevelRecommendInfoResponseModel({
    required this.recommend,
  });

  GetLevelRecommendInfoResponseModel copyWith({
    Section? recommend,
    Section? mom,
    Section? modified,
  }) =>
  ...
  factory GetLevelRecommendInfoResponseModel.fromJson(
      Map<String, dynamic> json) {
    return GetLevelRecommendInfoResponseModel(
      recommend: Section.fromJson(json['recommend']),
    );
  }
}
