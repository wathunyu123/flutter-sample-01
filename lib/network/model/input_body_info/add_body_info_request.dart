class AddBodyInfoRequestModel {
  ...
  AddBodyInfoRequestModel copyWith({
    String? nickname,
    String? address,
    String? phone,
    String? birth,
  ...
  factory AddBodyInfoRequestModel.fromJson(Map<String, dynamic> json) {
    return AddBodyInfoRequestModel(
